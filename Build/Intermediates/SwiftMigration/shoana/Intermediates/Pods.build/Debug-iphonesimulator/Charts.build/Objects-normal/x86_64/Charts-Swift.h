...
@interface RLMArray (SWIFT_EXTENSION(Charts))
@end


@interface RLMResults (SWIFT_EXTENSION(Charts))
@end
...
SWIFT_CLASS("_TtC6Charts12RealmBarData")
@interface RealmBarData : BarChartData
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results xValueField:(NSString * _Nonnull)xValueField dataSets:(NSArray<id <IChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@end

@class RLMRealm;
@class NSPredicate;

SWIFT_CLASS("_TtC6Charts16RealmBaseDataSet")
@interface RealmBaseDataSet : ChartBaseDataSet
- (void)initialize;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithLabel:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nullable)xIndexField label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results yValueField:(NSString * _Nonnull)yValueField label:(NSString * _Nullable)label;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nullable)xIndexField;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results yValueField:(NSString * _Nonnull)yValueField;
- (nonnull instancetype)initWithRealm:(RLMRealm * _Nullable)realm modelName:(NSString * _Nonnull)modelName resultsWhere:(NSString * _Nonnull)resultsWhere yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nullable)xIndexField label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly, copy) NSString * _Nullable xIndexField;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Null_unspecified)zone;
@end


SWIFT_CLASS("_TtC6Charts38RealmBarLineScatterCandleBubbleDataSet")
...
SWIFT_CLASS("_TtC6Charts15RealmBarDataSet")
@interface RealmBarDataSet : RealmBarLineScatterCandleBubbleDataSet <IBarChartDataSet>
- (void)initialize;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nullable)xIndexField label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nullable)xIndexField stackValueField:(NSString * _Nonnull)stackValueField label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nullable)xIndexField stackValueField:(NSString * _Nonnull)stackValueField;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results yValueField:(NSString * _Nonnull)yValueField stackValueField:(NSString * _Nonnull)stackValueField label:(NSString * _Nonnull)label;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results yValueField:(NSString * _Nonnull)yValueField stackValueField:(NSString * _Nonnull)stackValueField;
- (nonnull instancetype)initWithRealm:(RLMRealm * _Nullable)realm modelName:(NSString * _Nonnull)modelName resultsWhere:(NSString * _Nonnull)resultsWhere yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nullable)xIndexField label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRealm:(RLMRealm * _Nullable)realm modelName:(NSString * _Nonnull)modelName resultsWhere:(NSString * _Nonnull)resultsWhere yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nullable)xIndexField stackValueField:(NSString * _Nonnull)stackValueField label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRealm:(RLMRealm * _Nullable)realm modelName:(NSString * _Nonnull)modelName resultsWhere:(NSString * _Nonnull)resultsWhere yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nullable)xIndexField stackValueField:(NSString * _Nonnull)stackValueField;
...
SWIFT_CLASS("_TtC6Charts15RealmBubbleData")
@interface RealmBubbleData : BubbleChartData
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results xValueField:(NSString * _Nonnull)xValueField dataSets:(NSArray<id <IChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6Charts18RealmBubbleDataSet")
@interface RealmBubbleDataSet : RealmBarLineScatterCandleBubbleDataSet <IBubbleChartDataSet>
- (void)initialize;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nonnull)xIndexField sizeField:(NSString * _Nonnull)sizeField label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nonnull)xIndexField sizeField:(NSString * _Nonnull)sizeField;
- (nonnull instancetype)initWithRealm:(RLMRealm * _Nullable)realm modelName:(NSString * _Nonnull)modelName resultsWhere:(NSString * _Nonnull)resultsWhere yValueField:(NSString * _Nonnull)yValueField xIndexField:(NSString * _Nonnull)xIndexField sizeField:(NSString * _Nonnull)sizeField label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly) double xMin;
@property (nonatomic, readonly) double xMax;
@property (nonatomic, readonly) CGFloat maxSize;
@property (nonatomic) BOOL normalizeSizeEnabled;
...
SWIFT_CLASS("_TtC6Charts15RealmCandleData")
@interface RealmCandleData : CandleChartData
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results xValueField:(NSString * _Nonnull)xValueField dataSets:(NSArray<id <IChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6Charts34RealmLineScatterCandleRadarDataSet")
...
SWIFT_CLASS("_TtC6Charts18RealmCandleDataSet")
@interface RealmCandleDataSet : RealmLineScatterCandleRadarDataSet <ICandleChartDataSet>
- (void)initialize;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results highField:(NSString * _Nonnull)highField lowField:(NSString * _Nonnull)lowField openField:(NSString * _Nonnull)openField closeField:(NSString * _Nonnull)closeField xIndexField:(NSString * _Nonnull)xIndexField label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results highField:(NSString * _Nonnull)highField lowField:(NSString * _Nonnull)lowField openField:(NSString * _Nonnull)openField closeField:(NSString * _Nonnull)closeField xIndexField:(NSString * _Nonnull)xIndexField;
- (nonnull instancetype)initWithRealm:(RLMRealm * _Nullable)realm modelName:(NSString * _Nonnull)modelName resultsWhere:(NSString * _Nonnull)resultsWhere highField:(NSString * _Nonnull)highField lowField:(NSString * _Nonnull)lowField openField:(NSString * _Nonnull)openField closeField:(NSString * _Nonnull)closeField xIndexField:(NSString * _Nonnull)xIndexField label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (void)calcMinMaxWithStart:(NSInteger)start end:(NSInteger)end;
...
SWIFT_CLASS("_TtC6Charts15RealmChartUtils")
@interface RealmChartUtils : NSObject

/// Transforms the given Realm-ResultSet into an xValue array, using the specified xValueField
+ (NSArray<NSString *> * _Nonnull)toXValsWithResults:(RLMResults * _Nonnull)results xValueField:(NSString * _Nonnull)xValueField;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6Charts13RealmLineData")
@interface RealmLineData : LineChartData
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results xValueField:(NSString * _Nonnull)xValueField dataSets:(NSArray<id <IChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6Charts21RealmLineRadarDataSet")
...
SWIFT_CLASS("_TtC6Charts16RealmLineDataSet")
...
SWIFT_CLASS("_TtC6Charts12RealmPieData")
@interface RealmPieData : PieChartData
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results xValueField:(NSString * _Nonnull)xValueField dataSets:(NSArray<id <IChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6Charts15RealmPieDataSet")
...
SWIFT_CLASS("_TtC6Charts14RealmRadarData")
@interface RealmRadarData : RadarChartData
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results xValueField:(NSString * _Nonnull)xValueField dataSets:(NSArray<id <IChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6Charts17RealmRadarDataSet")
...
SWIFT_CLASS("_TtC6Charts16RealmScatterData")
@interface RealmScatterData : ScatterChartData
- (nonnull instancetype)initWithResults:(RLMResults * _Nullable)results xValueField:(NSString * _Nonnull)xValueField dataSets:(NSArray<id <IChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC6Charts19RealmScatterDataSet")
