...
- (BOOL)gestureRecognizerShouldBeginWithGestureRecognizer:(NSGestureRecognizer * _Nonnull)gestureRecognizer SWIFT_WARN_UNUSED_RESULT;
...
- (NSPoint)nsuiLocationOfTouch:(NSInteger)touch inView:(NSView * _Nullable)view SWIFT_WARN_UNUSED_RESULT;
@end
...
- (NSInteger)nsuiNumberOfTouches SWIFT_WARN_UNUSED_RESULT;
/// FIXME: Currently there are no more than 1 touch in OSX gestures, and not way to create custom touch gestures.
- (NSPoint)nsuiLocationOfTouch:(NSInteger)touch inView:(NSView * _Nullable)inView SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface NSString (SWIFT_EXTENSION(Charts))
@end


@interface NSTouch (SWIFT_EXTENSION(Charts))
/// Touch locations on OS X are relative to the trackpad, whereas on iOS they are actually <em>on</em> the view.
- (NSPoint)locationInViewWithView:(NSView * _Nonnull)view SWIFT_WARN_UNUSED_RESULT;
@end
